...
# python yolo2coco.py --root_dir train --save_path train.json
# python yolo2coco.py --root_dir valid --save_path val.json
# python yolo2coco.py --root_dir test --save_path test.json
        ...
        with open(os.path.join(originLabelsDir, txtFile), 'r') as fr:
            ...
            for label in labelList:
                ...
                dataset['annotations'].append({
                    ...
                    'category_id': cls_id,
                    'id': ann_id_cnt,
                    'image_id': os.path.splitext(index)[0],
                    'iscrowd': 0,
