...
def parse_opt():
    ...
    parser.add_argument('--label_coco', type=str, default='./data/coco/annotations/test.json',
                        help='label coco path')
    # parser.add_argument('--pred_coco', type=str, default='runs/val/exp/predictions.json', help='pred coco path')
    parser.add_argument('--pred_coco', type=str, default='./output/gfl/gfl.pkl', help='pred coco path')
